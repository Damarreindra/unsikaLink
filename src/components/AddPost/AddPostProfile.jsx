...
import ModalComponentProfile from "./ModalComponentProfile";
...
const AddPostProfile = () => {
  ...
  const createdAt = Date.now()
    ...
    const handleSubmit = (e) =>{
        e.preventDefault();
        dispatch(addPostProfile({title: title, createdAt, content: content, publish: publish}))
        }
  ...
  return (
    ...
    <div>
      ...
      <ModalComponentProfile show={isModalShow} HideHandler={HandleShowModal} />
